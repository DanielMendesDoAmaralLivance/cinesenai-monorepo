          ...
          <div className="col-span-4">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground text-balance sm:text-base">
                ...
                alienígena expressivo que foi adotado como animal de estimação
                por Lilo (Maia Kealoha) e juntos eles descobrem o significado de
                família. Classificação indicativa 10 Anos. Contém temas
                sensíveis, violência fantasiosa.
              </p>
            </div>
